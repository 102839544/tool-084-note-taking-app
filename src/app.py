...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 笔记应用", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "note-taking-app".lower() or "clock" in "note-taking-app".lower():
            self.setup_timer_ui(main)
        elif "random" in "note-taking-app".lower() or "dice" in "note-taking-app".lower() or "coin" in "note-taking-app".lower():
            self.setup_random_ui(main)
        elif "note" in "note-taking-app".lower() or "todo" in "note-taking-app".lower():
    ...
    def generate_random(self):
        if "dice" in "note-taking-app".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "note-taking-app".lower():
